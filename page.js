...
export default function Home() {
  ...
  return (
    <>
      {/* CSS injection to completely override layout and maximize width */}
      <style>{`
        html, body, #__next {
          margin: 0 !important;
          padding: 0 !important;
      ...
      <div style={{ minHeight: "100vh", width: "100%", backgroundColor: "#FFD700", color: "#121212", display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 20px", boxSizing: "border-box", fontFamily: "sans-serif" }}>
        ...
        {/* Top Bar - Color fixed to Solid Black for extreme visibility */}
        ...
        {/* Main Dashboard Box - Royal Blue Card Container */}
        <div style={{ width: "100%", maxWidth: "800px", backgroundColor: "#1E3A8A", borderRadius: "32px", padding: "60px 40px", border: "2px solid #121212", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", boxSizing: "border-box", boxShadow: "0px 25px 50px rgba(0,0,0,0.3)", margin: "auto 0" }}>
          ...
          <div style={{ width: "100%", backgroundColor: "#172554", borderRadius: "16px", padding: "20px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "45px", border: "1px solid #3b82f6", boxSizing: "border-box" }}>
            ...
            <button style={{ fontSize: "14px", color: "#FFD700", backgroundColor: "#1E3A8A", padding: "10px 24px", borderRadius: "12px", border: "1px solid #3b82f6", fontWeight: "700", cursor: "pointer" }}>Copy</button>
          </div>

          {/* ACTION BUTTON - Made much LARGER, BOLDER, with solid BLACK text for high visibility */}
          <button style={{ width: "100%", backgroundColor: "#FFD700", color: "#121212", fontWeight: "900", padding: "26px", borderRadius: "20px", border: "3px solid #121212", fontSize: "24px", cursor: "pointer", letterSpacing: "0.02em", boxShadow: "0px 8px 0px #121212", transition: "transform 0.1s" }}>
            Connect Fingerprint Passkey
          </button>
        </div>

        {/* Bottom Swipe Indicator - Fixed to Solid Black */}
